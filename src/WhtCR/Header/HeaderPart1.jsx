...
const HeaderPart = () => {
    ...
    return (
        <>
            <div className='flex items-center flex-col lg:flex-row lg:gap-20 w-full justify-around max-lg:px-3 lg:px-10'>
                <div className='flex items-center max:lg:justify-start py-5'>
                    <img src="./mainlogo.jpg" alt="" className='h-32 w-40' />
                    <FaShoppingCart className='size-10 text-[#ffbd59] lg:hidden'></FaShoppingCart>
                </div>
                ...
                <div className='relative max-lg:hidden cursor-pointer'>
                    <p className={`flex justify-center text-[18px] font-semibold hover:text-yellow-400`} onClick={handleLoginClick}>
                        Login <IoMdArrowDropdown className={`mt-1 ml-1 ${isDropdownOpen ? 'open' : ''}`}></IoMdArrowDropdown>
                    </p>
                    {isDropdownOpen && (
                        <div className="absolute top-full left-1/2 transform -translate-x-1/2 bg-white shadow-md w-40 items-center  text-center ">
                            <p className='text-[19px] py-2 font-semibold text-yellow-400  hover:bg-yellow-400  hover:text-white' onClick={handleloginClick}>Login</p>
                            <hr />
                            <p className='text-[19px] py-2 font-semibold text-yellow-400  hover:bg-yellow-400  hover:text-white' onClick={handleSignUpClick}>Sign Up</p>
                        </div>
                    )}
                </div>
                {isPopupOpen && (
                ...
                <div className='flex flex-col lg:flex-row gap-10 max-lg:hidden'>
                    <FaRegHeart className='size-7'> aa</FaRegHeart>
                </div>
                <div className='flex flex-col lg:flex-row gap-10 max-lg:hidden'>
                    <FaShoppingCart className='size-7'></FaShoppingCart>
                </div>
            </div>
        </>
    )
