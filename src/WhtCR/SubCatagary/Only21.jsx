...
const Only21 = ({ sortCriteria, updateTotalResults, handleCardClick }) => {
    const All21 = [
        {
            id: 107,
    ...
    useEffect(() => {
        updateTotalResults(All21.length);
    }, [All21 .length, updateTotalResults]);
    ...
    const paginatedItems = All21 .slice((currentPage - 1) * itemsPerPage, currentPage * itemsPerPage);

    const totalPages = Math.ceil(All21 .length / itemsPerPage);
    return (
        <>
