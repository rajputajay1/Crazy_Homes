...
const Detail = () => {
    ...
    const { addToCart, message, cartCount } = useCart(); // Destructure addToCart, message, and cartCount from useCart
            ...
            <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
                <div className="flex flex-col md:flex-row -mx-4">
                    <div className="md:flex-1 px-4">
                        <div className="h-[500px] rounded-lg bg-gray-300 dark:bg-gray-700 mb-4">
                        ...
                        <p className="text-gray-600 dark:text-gray-300 text-[15px] mt-4">
