    ...
    return (
        <>
            <section class="bg-blue-50 dark:bg-slate-800" id="contact">
                <div class="mx-auto max-w-7xl px-4 max-lg:py-6 sm:px-6 lg:px-8 lg:py-10">
                    <div class="mb-4">
                        ...
                        <div class="grid md:grid-cols-2">
                            <div class="h-full pr-6">
                                <p class="mt-3 mb-12 text-lg text-gray-600 dark:text-slate-400">
                                   Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minima velit cum aperiam magni numquam quaerat architecto officiis saepe corrupti suscipit error itaque perspiciatis culpa fuga, odio exercitationem debitis inventore ut!
                                </p>
                                <ul class="mb-6 md:mb-0">
                                    ...
                                    <li class="flex">
                                        ...
                                        <div class="ml-4 mb-4">
                                            ...
                                            <p class="text-gray-600 dark:text-slate-400">Mobile: +91 9501433347</p>
                                            <p class="text-gray-600 dark:text-slate-400">Mail: info.techquasarservices@gmail.com</p>
                                        </div>
                                    </li>
                                    <li class="flex">
                                        <div class="flex h-10 w-10 items-center justify-center rounded bg-blue-900 text-gray-50">
